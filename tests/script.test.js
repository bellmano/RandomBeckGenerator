...
global.beckMovies = [
  {
    number: 1,
    title: "Beck - Lockpojken",
    year: 1997,
    description: "Test movie 1",
    imdbRating: "6.2",
    tv4playUrl: "https://tv4play.se/1",
  },
  {
    number: 2,
    title: "Beck - Monstret",
  ...
  {
    number: 5,
    title: "Beck - Pojken i glaskulan",
    year: 2002,
    description: "Test movie 5",
  },
  {
    number: 6,
    title: "Beck - Only Runtime",
    year: 2004,
    description: "Test movie with only runtime",
    runtime: "105 min",
  },
];
...
describe("Main Script Tests", () => {
  ...
  test("should handle movie without optional fields", () => {
    ...
    expect(
      document.getElementById("movie-rating").classList.contains("hidden"),
    ).toBe(true);
  ...
  test("should generate with all movies checkbox", () => {
    ...
    expect(
      document.getElementById("movie-result").classList.contains("hidden"),
    ).toBe(false);
  });
  ...
  test("should handle movie not found and exceptions", () => {
    ...
    // Test exception
    generator.getRandomNumber = jest.fn(() => {
